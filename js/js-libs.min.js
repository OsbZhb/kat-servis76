!(function (e, t) {
  ...
  function r(e, t, n) {
    return le.isFunction(t)
      ? le.grep(e, function (e, i) {
  ...
  function c(e, t, n, i) {
    var o;
    try {
      e && le.isFunction((o = e.promise))
        ? o.call(e).done(t).fail(n)
        : e && le.isFunction((o = e.then))
        ? o.call(e, t, n)
  ...
  function p(e, t, n) {
    ...
    if (void 0 === n && 1 === e.nodeType)
      if (
        ((i = "data-" + t.replace(He, "-$&").toLowerCase()),
  ...
  function f(e, t, n, i) {
    var o,
      ...
      d = (le.cssNumber[t] || ("px" !== c && +l)) && Le.exec(le.css(e, t));
    if (d && d[3] !== c) {
      (c = c || d[3]), (n = n || []), (d = +l || 1);
      do {
        (d /= r = r || ".5"), le.style(e, t, d + c);
      } while (r !== (r = a() / l) && 1 !== r && --s);
    }
    return (
      n &&
  ...
  function v(e, t) {
    for (var n, i, o = [], r = 0, s = e.length; r < s; r++)
      (i = e[r]).style &&
        ...
        t
          ? ("none" === n &&
              ((o[r] = Ee.get(i, "display") || null),
              o[r] || (i.style.display = "")),
            "" === i.style.display && Pe(i) && (o[r] = h(i)))
          : "none" !== n && ((o[r] = "none"), Ee.set(i, "display", n)));
    ...
    return (
      (n =
        void 0 !== e.getElementsByTagName
          ...
          : []),
      void 0 === t || (t && o(e, t)) ? le.merge([e], n) : n
    );
  }
  function y(e, t) {
        ...
        if ("object" === le.type(r)) le.merge(p, r.nodeType ? [r] : r);
          ...
          for (
            s = s || u.appendChild(t.createElement("div")),
              a = (Ie.exec(r) || ["", ""])[1].toLowerCase(),
              l = We[a] || We._default,
              s.innerHTML = l[1] + le.htmlPrefilter(r) + l[2],
              d = l[0];
            d--;

          )
            s = s.lastChild;
          le.merge(p, s.childNodes), ((s = u.firstChild).textContent = "");
        } else p.push(t.createTextNode(r));
    for (u.textContent = "", f = 0; (r = p[f++]); )
      if (i && le.inArray(r, i) > -1) o && o.push(r);
      else if (
        ((c = le.contains(r.ownerDocument, r)),
        (s = g(u.appendChild(r), "script")),
        c && y(s),
        n)
      )
        for (d = 0; (r = s[d++]); ) ze.test(r.type || "") && n.push(r);
    return u;
  }
  function w() {
    return !0;
  ...
  function $(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        Ee.hasData(e) &&
        ((r = Ee.access(e)), (s = Ee.set(t, r)), (c = r.events))
      )
        for (o in (delete s.handle, (s.events = {}), c))
          for (n = 0, i = c[o].length; n < i; n++) le.event.add(t, o, c[o][n]);
      je.hasData(e) &&
        ((a = je.access(e)), (l = le.extend({}, a)), je.set(t, l));
    }
  }
  function A(e, t) {
  ...
  function E(e, t, i, o) {
    ...
    var r,
      ...
      h = t[0],
      v = le.isFunction(h);
    if (v || (p > 1 && "string" == typeof h && !se.checkClone && Ge.test(h)))
    ...
    if (
      p &&
      ((s = (r = m(t, e[0].ownerDocument, !1, e, o)).firstChild),
      1 === r.childNodes.length && (r = s),
      s || o)
    ) {
      for (l = (a = le.map(g(r, "script"), S)).length; u < p; u++)
        (c = r),
          u !== f &&
            ((c = le.clone(c, !0, !0)), l && le.merge(a, g(c, "script"))),
          i.call(e[u], c, u);
      if (l)
        for (d = a[a.length - 1].ownerDocument, le.map(a, C), u = 0; u < l; u++)
          (c = a[u]),
            ze.test(c.type || "") &&
              !Ee.access(c, "globalEval") &&
              le.contains(d, c) &&
              (c.src
                ? le._evalUrl && le._evalUrl(c.src)
                : n(c.textContent.replace(Je, ""), d));
    }
    return e;
  }
  function j(e, t, n) {
    for (var i, o = t ? le.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
      n || 1 !== i.nodeType || le.cleanData(g(i)),
        i.parentNode &&
          (n && le.contains(i.ownerDocument, i) && y(g(i, "script")),
  ...
  function O(e, t, n, i, o) {
    ...
    for (
      ...
      "margin" === n && (s += le.css(e, n + Oe[r], !0, o)),
        i
          ? ("content" === n && (s -= le.css(e, "padding" + Oe[r], !0, o)),
            "margin" !== n &&
              (s -= le.css(e, "border" + Oe[r] + "Width", !0, o)))
          : ((s += le.css(e, "padding" + Oe[r], !0, o)),
            "padding" !== n &&
              (s += le.css(e, "border" + Oe[r] + "Width", !0, o)));
    return s;
  }
  function P(e, t, n) {
    ...
    return Ze.test(r)
      ? r
      : ((i = s && (se.boxSizingReliable() || r === e.style[t])),
        "auto" === r && (r = e["offset" + t[0].toUpperCase() + t.slice(1)]),
        (r = parseFloat(r) || 0) +
          O(e, t, n || (s ? "border" : "content"), i, o) +
          "px");
  }
  ...
  function z(e, t, n) {
    for (
      var i,
        o = (W.tweeners[t] || []).concat(W.tweeners["*"]),
        r = 0,
        s = o.length;
      r < s;
      r++
  ...
  function W(e, t, n) {
    ...
    for (
      (function (e, t) {
        ...
        for (n in e)
          if (
            ((o = t[(i = le.camelCase(n))]),
            (r = e[n]),
            Array.isArray(r) && ((o = r[1]), (r = e[n] = r[0])),
            n !== i && ((e[i] = r), delete e[n]),
            (s = le.cssHooks[i]) && ("expand" in s))
          )
      ...
      if ((i = W.prefilters[r].call(c, e, d, c.opts)))
        return (
          le.isFunction(i.stop) &&
            (le._queueHooks(c.elem, c.opts.queue).stop = le.proxy(i.stop, i)),
          i
        );
    return (
      le.map(d, z, c),
  ...
  (le.fn = le.prototype =
        ...
        for (
          ...
          if (null != (e = arguments[a]))
            for (t in e)
              (n = s[t]),
                s !== (i = e[t]) &&
                  (c && i && (le.isPlainObject(i) || (o = Array.isArray(i)))
                    ? (o
                        ? ((o = !1), (r = n && Array.isArray(n) ? n : []))
                        : (r = n && le.isPlainObject(n) ? n : {}),
                      (s[t] = le.extend(c, r, i)))
                    : void 0 !== i && (s[t] = i));
        return s;
      }),
    ...
    "function" == typeof Symbol &&
      (le.fn[Symbol.iterator] = V[Symbol.iterator]),
    le.each(
  ...
  var fe = (function (e) {
    function t(e, t, n, i) {
      ...
      if (
        !i &&
        ((t ? t.ownerDocument || t : W) !== L && N(t), (t = t || L), P)
      ) {
        if (11 !== h && (l = ye.exec(e)))
          if ((o = l[1])) {
            if (9 === h) {
            ...
            if (l) {
              ...
              for (; (t = t[i]); )
                if (1 === t.nodeType || s)
                  if (
                    ((d =
                      (u = t[z] || (t[z] = {}))[t.uniqueID] ||
                      (u[t.uniqueID] = {})),
                    o && o === t.nodeName.toLowerCase())
                  )
                    t = t[i] || t;
                  else {
                    if ((c = d[r]) && c[0] === R && c[1] === a)
                      return (p[2] = c[2]);
    ...
    function w(e) {
      for (
        ...
        if ((n = k.relative[e[a].type])) d = [h(v(d), n)];
          ...
          if ((n = k.filter[e[a].type].apply(null, e[a].matches))[z]) {
      ...
      function (e) {
        ...
        return i !== L && 9 === i.nodeType && i.documentElement
          ? ((O = (L = i).documentElement),
            ...
            (M = []),
            (q = []),
            (T.qsa = ge.test(L.querySelectorAll)) &&
              (o(function (e) {
                (O.appendChild(e).innerHTML =
                  ...
                  e.querySelectorAll("[selected]").length ||
                    q.push("\\[" + ne + "*(?:value|" + te + ")"),
                  e.querySelectorAll("[id~=" + z + "-]").length || q.push("~="),
              ...
              ? function (e, t) {
                  ...
                  return (
                    ...
                    (!T.sortDetached && t.compareDocumentPosition(e) === n)
                      ? e === L || (e.ownerDocument === W && I(W, e))
                        ? -1
                        : t === L || (t.ownerDocument === W && I(W, t))
                        ? 1
                        : D
                        ? ee(D, e) - ee(D, t)
                        : 0
                    ...
                    if (((h = [s ? g.firstChild : g.lastChild]), s && m)) {
                      ...
                      (m &&
                        (w = f =
                          (c =
                            (d =
                              (u = (p = t)[z] || (p[z] = {}))[p.uniqueID] ||
                              (u[p.uniqueID] = {}))[e] || [])[0] === R && c[1]),
                      !1 === w)
                    )
                      for (
                        ;
    ...
    return (
        ...
        function (e, t) {
          ...
          if (!r) {
            for (t || (t = $(e)), n = t.length; n--; )
              (r = w(t[n]))[z] ? i.push(r) : o.push(r);
            (r = _(e, b(o, i))).selector = e;
          }
          return r;
        }),
      (E = t.select =
      ...
      (T.sortStable = z.split("").sort(Y).join("") === z),
  ...
  (le.filter = function (e, t, n) {
    ...
    le.fn.extend({
        ...
        if ("string" != typeof e)
          return this.pushStack(
            le(e).filter(function () {
              for (t = 0; t < i; t++) if (le.contains(o[t], this)) return !0;
            })
          );
      ...
      is: function (e) {
        return !!r(
          this,
          "string" == typeof e && ge.test(e) ? le(e) : e || [],
          !1
        ).length;
      },
    });
    ...
    if (((n = n || we), "string" == typeof e)) {
      ...
      if (i[1]) {
        if (
          ...
          le.merge(
            this,
            le.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : G, !0)
          ),
      ...
      function (e, t) {
        le.fn[e] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 &&
              (Te[e] || le.uniqueSort(o), xe.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
    ...
    e =
      "string" == typeof e
        ? (function (e) {
            var t = {};
            return (
              le.each(e.match(ke) || [], function (e, n) {
                t[n] = !0;
              }),
              t
            );
              ...
              (function t(n) {
                le.each(n, function (n, i) {
                  le.isFunction(i)
                    ...
                    : i && i.length && "string" !== le.type(i) && t(i);
                });
              })(arguments),
              n && !t && l()),
            this
        ...
        remove: function () {
          return (
            le.each(arguments, function (e, t) {
              for (var n; (n = le.inArray(t, r, n)) > -1; )
                r.splice(n, 1), n <= a && a--;
            }),
            this
          );
        ...
        var n = [
          ...
          o = {
            ...
            then: function (t, i, o) {
                    ...
                    u = function () {
                      ...
                      if (!(t < s)) {
                        ...
                        (u =
                          ...
                          le.isFunction(u)
                            ? o
                              ? u.call(e, r(s, n, a, o), r(s, n, l, o))
                              : (s++,
                                u.call(
                                  e,
                                  r(s, n, a, o),
                                  r(s, n, l, o),
                                  r(s, n, a, n.notifyWith)
                                ))
                            : (i !== a && ((c = void 0), (d = [e])),
                              (o || n.resolveWith)(c, d));
                      }
                      ...
                      : function () {
                          try {
                            ...
                            le.Deferred.exceptionHook &&
                              le.Deferred.exceptionHook(e, p.stackTrace),
                              t + 1 >= s &&
                                (i !== l && ((c = void 0), (d = [e])),
                                n.rejectWith(c, d));
                          }
              ...
              return le
                .Deferred(function (e) {
                  n[0][3].add(r(0, e, le.isFunction(o) ? o : a, e.notifyWith)),
                    n[1][3].add(r(0, e, le.isFunction(t) ? t : a)),
                    n[2][3].add(r(0, e, le.isFunction(i) ? i : l));
                })
                .promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        var t = arguments.length,
          ...
          s = function (e) {
            return function (n) {
              (i[e] = this),
                (o[e] = arguments.length > 1 ? J.call(arguments) : n),
                --t || r.resolveWith(i, o);
            };
          };
        if (
          t <= 1 &&
          (c(e, r.done(s(n)).resolve, r.reject, !t),
          "pending" === r.state() || le.isFunction(o[n] && o[n].then))
        )
          return r.then();
    ...
    le.extend({
      ...
      ready: function (e) {
        (!0 === e ? --le.readyWait : le.isReady) ||
          ((le.isReady = !0),
          (!0 !== e && --le.readyWait > 0) || Ce.resolveWith(G, [le]));
      },
    }),
    (le.ready.then = Ce.then),
    "complete" === G.readyState ||
    ("loading" !== G.readyState && !G.documentElement.doScroll)
      ? e.setTimeout(le.ready)
  ...
  (u.uid = 1),
    (u.prototype = {
      ...
      set: function (e, t, n) {
        ...
        else for (i in t) o[le.camelCase(i)] = t[i];
        return o;
      },
      get: function (e, t) {
        return void 0 === t
          ? this.cache(e)
          : e[this.expando] && e[this.expando][le.camelCase(t)];
      },
      ...
      remove: function (e, t) {
        ...
        if (void 0 !== i) {
          if (void 0 !== t) {
            Array.isArray(t)
              ? (t = t.map(le.camelCase))
              : (t = (t = le.camelCase(t)) in i ? [t] : t.match(ke) || []),
              (n = t.length);
            for (; n--; ) delete i[t[n]];
          }
          (void 0 === t || le.isEmptyObject(i)) &&
  ...
  le.extend({
    hasData: function (e) {
      return je.hasData(e) || Ee.hasData(e);
    },
    data: function (e, t, n) {
    ...
    le.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((o = je.get(r)), 1 === r.nodeType && !Ee.get(r, "hasDataAttrs"))
          ) {
            for (n = s.length; n--; )
              s[n] &&
                0 === (i = s[n].name).indexOf("data-") &&
                ((i = le.camelCase(i.slice(5))), p(r, i, o[i]));
        ...
        return "object" == typeof e
          ...
          : $e(
              ...
              function (t) {
                var n;
                if (r && void 0 === t) {
                  if (void 0 !== (n = je.get(r, e))) return n;
      ...
      queue: function (e, t, n) {
        ...
        if (e)
          return (
            ...
            n &&
              (!i || Array.isArray(n)
                ? (i = Ee.access(e, t, le.makeArray(n)))
                : i.push(n)),
            i || []
          );
      },
  ...
  (le.event = {
      ...
      if (g)
        for (
          n.handler && ((n = (r = n).handler), (o = r.selector)),
            o && le.find.matchesSelector(Be, o),
            n.guid || (n.guid = le.guid++),
            (l = g.events) || (l = g.events = {}),
            (s = g.handle) ||
              (s = g.handle =
                function (t) {
                  return void 0 !== le && le.event.triggered !== t.type
        ...
        for (c = (t = (t || "").match(ke) || [""]).length; c--; )
          if (
            ...
            s &&
              ...
              delete l[f]);
          } else for (f in l) le.event.remove(e, f + t[c], n, i, !0);
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          s = le.event.handlers.call(this, a, c), t = 0;
          ...
          for (
            ...
            (a.rnamespace && !a.rnamespace.test(r.namespace)) ||
              ...
              void 0 !==
                (i = (
                  (le.event.special[r.origType] || {}).handle || r.handler
                ).apply(o.elem, l)) &&
                !1 === (a.result = i) &&
  ...
  le.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (s = g(a), i = 0, o = (r = g(e)).length; i < o; i++) A(r[i], s[i]);
      if (t)
        if (n)
          for (r = r || g(e), s = s || g(a), i = 0, o = r.length; i < o; i++)
            $(r[i], s[i]);
        else $(e, a);
      return (s = g(a, "script")).length > 0 && y(s, !l && g(e, "script")), a;
    },
      ...
      for (var t, n, i, o = le.event.special, r = 0; void 0 !== (n = e[r]); r++)
        if (Ae(n)) {
          if ((t = n[Ee.expando])) {
            if (t.events)
              for (i in t.events)
                o[i] ? le.event.remove(n, i) : le.removeEvent(n, i, t.handle);
            n[Ee.expando] = void 0;
          }
    ...
    le.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (le.cleanData(g(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
        ...
        return $e(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !Ve.test(e) &&
              !We[(Ie.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
              e = le.htmlPrefilter(e);
              try {
                for (; n < i; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (le.cleanData(g(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return E(
          ...
          function (t) {
            ...
            le.inArray(this, e) < 0 &&
              (le.cleanData(g(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
    ...
    le.each(
      ...
      function (e, t) {
        le.fn[e] = function (e) {
          for (var n, i = [], o = le(e), r = o.length - 1, s = 0; s <= r; s++)
  ...
  le.extend({
    ...
    le.each(["height", "width"], function (e, t) {
      le.cssHooks[t] = {
        get: function (e, n, i) {
          if (n)
            return !tt.test(le.css(e, "display")) ||
        ...
        set: function (e, n, i) {
          var o,
            ...
            s =
              i &&
              O(e, t, i, "border-box" === le.css(e, "boxSizing", !1, r), r);
          return (
            s &&
              (o = Le.exec(n)) &&
              "px" !== (o[3] || "px") &&
    ...
    (q.prototype = {
      ...
      init: function (e, t, n, i, o, r) {
        (this.elem = e),
          (this.prop = n),
          (this.easing = o || le.easing._default),
          (this.options = t),
    ...
    tweeners: {
      "*": [
        function (e, t) {
          ...
          return f(n.elem, e, Le.exec(t), n), n;
        },
      ],
    },
      ...
      function (e, t, n) {
        ...
        t))
          if (((o = t[i]), ct.test(o))) {
            ...
            f[i] = (y && y[i]) || le.style(e, i);
          }
        if ((l = !le.isEmptyObject(t)) || !le.isEmptyObject(f))
          for (i in (u &&
            1 === e.nodeType &&
            ((n.overflow = [h.overflow, h.overflowX, h.overflowY]),
            null == (c = y && y.display) && (c = Ee.get(e, "display")),
            "none" === (d = le.css(e, "display")) &&
              (c
                ? (d = c)
                : (v([e], !0),
                  (c = e.style.display || c),
          ...
          f))
            l ||
              (y
                ...
                : (y = Ee.access(e, "fxshow", { display: c })),
              r && (y.hidden = !g),
              g && v([e], !0),
              p.done(function () {
                for (i in (g || v([e]), Ee.remove(e, "fxshow"), f))
                  le.style(e, i, f[i]);
              })),
              (l = z(g ? y[i] : 0, i, p)),
              i in y ||
                ((y[i] = l.start), g && ((l.end = l.start), (l.start = 0)));
      },
    ],
        ...
        le.fx.off
          ...
          : "number" != typeof i.duration &&
            (i.duration in le.fx.speeds
              ? (i.duration = le.fx.speeds[i.duration])
              : (i.duration = le.fx.speeds._default)),
  ...
  var ut,
    pt = le.expr.attrHandle;
  le.fn.extend({
    attr: function (e, t) {
      return $e(this, le.attr, e, t, arguments.length > 1);
    },
          ...
          return void 0 === e.getAttribute
            ...
            : ((1 === r && le.isXMLDoc(e)) ||
                (o =
                  ...
                  (le.expr.match.bool.test(t) ? ut : void 0)),
              void 0 !== n
                ? null === n
  ...
  le.fn.extend({
    prop: function (e, t) {
      return $e(this, le.prop, e, t, arguments.length > 1);
    },
    ...
    le.extend({
      prop: function (e, t, n) {
        ...
        if (3 !== r && 8 !== r && 2 !== r)
          return (
            (1 === r && le.isXMLDoc(e)) ||
              ((t = le.propFix[t] || t), (o = le.propHooks[t])),
            void 0 !== n
              ? o && "set" in o && void 0 !== (i = o.set(e, n, t))
                ? i
                : (e[t] = n)
      ...
      addClass: function (e) {
        ...
        if ("string" == typeof e && e)
          for (t = e.match(ke) || []; (n = this[l++]); )
            if (((o = B(n)), (i = 1 === n.nodeType && " " + R(o) + " "))) {
              for (s = 0; (r = t[s++]); )
                i.indexOf(" " + r + " ") < 0 && (i += r + " ");
              o !== (a = R(i)) && n.setAttribute("class", a);
            }
        return this;
      },
      ...
      toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && "string" === n
          ...
          : this.each(function () {
              var t, i, o, r;
              if ("string" === n)
                for (i = 0, o = le(this), r = e.match(ke) || []; (t = r[i++]); )
                  o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
              else
                (void 0 !== e && "boolean" !== n) ||
                  ((t = B(this)) && Ee.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
                      t || !1 === e ? "" : Ee.get(this, "__className__") || ""
                    ));
            });
      },
      hasClass: function (e) {
        var t,
          ...
          i = 0;
        for (t = " " + e + " "; (n = this[i++]); )
          if (1 === n.nodeType && (" " + R(B(n)) + " ").indexOf(t) > -1)
            return !0;
        return !1;
      },
    });
      ...
      return arguments.length
        ? ((i = le.isFunction(e)),
          this.each(function (n) {
            var o;
            1 === this.nodeType &&
              (null == (o = i ? e.call(this, n, le(this).val()) : e)
                ? (o = "")
                : "number" == typeof o
                ? (o += "")
                : Array.isArray(o) &&
        ...
        : o
        ? (t = le.valHooks[o.type] || le.valHooks[o.nodeName.toLowerCase()]) &&
          "get" in t &&
    ...
    le.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var n, i, o = e.options, r = le.makeArray(t), s = o.length;
              s--;

            )
              ((i = o[s]).selected =
                le.inArray(le.valHooks.option.get(i), r) > -1) && (n = !0);
  ...
  le.extend(le.event, {
    trigger: function (t, n, i, o) {
      ...
      if (
        ...
        3 !== i.nodeType &&
          8 !== i.nodeType &&
          !gt.test(f + le.event.triggered) &&
          (f.indexOf(".") > -1 &&
            ((h = f.split(".")), (f = h.shift()), h.sort()),
          (c = f.indexOf(":") < 0 && "on" + f),
          ((t = t[le.expando]
            ? t
            : new le.Event(f, "object" == typeof t && t)).isTrigger = o
            ? 2
            : 3),
          (t.namespace = h.join(".")),
          ...
          (t.result = void 0),
          t.target || (t.target = i),
          (n = null == n ? [t] : le.makeArray(n, [t])),
          (u = le.event.special[f] || {}),
          o || !u.trigger || !1 !== u.trigger.apply(i, n)))
      ) {
        if (!o && !u.noBubble && !le.isWindow(i)) {
          for (
            l = u.delegateType || f, gt.test(l + f) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            p.push(s), (a = s);
        ...
        for (r = 0; (s = p[r++]) && !t.isPropagationStopped(); )
          (t.type = r > 1 ? l : u.bindType || f),
            (d = (Ee.get(s, "events") || {})[t.type] && Ee.get(s, "handle")) &&
              d.apply(s, n),
            (d = c && s[c]) &&
              d.apply &&
              Ae(s) &&
      ...
      le.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
        ...
        le.event.special[t] = {
          ...
          teardown: function () {
            ...
            o
              ? Ee.access(i, t, o)
              : (i.removeEventListener(e, n, !0), Ee.remove(i, t));
          },
        };
      });
  var yt = e.location,
  ...
  (Lt.href = yt.href),
    le.extend({
      ...
      ajax: function (t, n) {
            ...
            c
              ? (h.ifModified &&
                  ((x = k.getResponseHeader("Last-Modified")) &&
                    (le.lastModified[r] = x),
                  (x = k.getResponseHeader("etag")) && (le.etag[r] = x)),
                204 === t || "HEAD" === h.type
                  ? (T = "nocontent")
                  : 304 === t
                  ? (T = "notmodified")
        ...
        var o,
          ...
          h = le.ajaxSetup({}, n),
          v = h.context || h,
          g = h.context && (v.nodeType || v.jquery) ? le(v) : le.event,
          y = le.Deferred(),
        ...
        if (
          (h.data &&
            ...
            (h.data = le.param(h.data, h.traditional)),
          _(Dt, h, n, k),
          d)
        )
          return k;
        for (p in ((u = le.event && h.global) &&
          0 == le.active++ &&
          le.event.trigger("ajaxStart"),
        ...
        h.hasContent
          ...
          : ((f = h.url.slice(r.length)),
            h.data && ((r += (wt.test(r) ? "&" : "?") + h.data), delete h.data),
            !1 === h.cache &&
              ((r = r.replace($t, "$1")),
              (f = (wt.test(r) ? "&" : "?") + "_=" + mt++ + f)),
            (h.url = r + f)),
        h.ifModified &&
          (le.lastModified[r] &&
            k.setRequestHeader("If-Modified-Since", le.lastModified[r]),
          le.etag[r] && k.setRequestHeader("If-None-Match", le.etag[r])),
    ...
    le.each(["get", "post"], function (e, t) {
      le[t] = function (e, n, i, o) {
        return (
          le.isFunction(n) && ((o = o || i), (i = n), (n = void 0)),
          le.ajax(
            le.extend(
    ...
    le.fn.extend({
      wrapAll: function (e) {
        ...
        return (
          this[0] &&
            (le.isFunction(e) && (e = e.call(this[0])),
            (t = le(e, this[0].ownerDocument).eq(0).clone(!0)),
  ...
  (se.cors = !!Pt && "withCredentials" in Pt),
    (se.ajax = Pt = !!Pt),
    le.ajaxTransport(function (t) {
      var n, i;
      if (se.cors || (Pt && !t.crossDomain))
        return {
          send: function (o, r) {
            var s,
              a = t.xhr();
  ...
  le.ajaxSetup({
    ...
    le.ajaxPrefilter("json jsonp", function (t, n, i) {
      ...
      if (a || "jsonp" === t.dataTypes[0])
        return (
          (o = t.jsonpCallback =
            le.isFunction(t.jsonpCallback)
              ? t.jsonpCallback()
              : t.jsonpCallback),
          a
            ? (t[a] = t[a].replace(Mt, "$1" + o))
            : !1 !== t.jsonp &&
          ...
          i.always(function () {
            void 0 === r ? le(e).removeProp(o) : (e[o] = r),
    ...
    (le.fn.load = function (e, t, n) {
      var i,
        ...
        a = e.indexOf(" ");
      return (
        a > -1 && ((i = R(e.slice(a))), (e = e.slice(0, a))),
        le.isFunction(t)
          ? ((n = t), (t = void 0))
    ...
    le.each(["top", "left"], function (e, t) {
      le.cssHooks[t] = H(se.pixelPosition, function (e, n) {
        if (n)
          return (n = D(e, t)), Ze.test(n) ? le(e).position()[t] + "px" : n;
      });
    }),
  ...
  var Ft = e.jQuery,
    It = e.$;
  return (
    (le.noConflict = function (t) {
      return (
        e.$ === le && (e.$ = It), t && e.jQuery === le && (e.jQuery = Ft), le
      );
    }),
    t || (e.jQuery = e.$ = le),
    le
